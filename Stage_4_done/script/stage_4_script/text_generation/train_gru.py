...
from local_code.stage_4_code.text_generation.Method_GRU import Method_GRU
...
def main():
    ...
    result_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), "result/stage_4_result/text_generation/gru")
