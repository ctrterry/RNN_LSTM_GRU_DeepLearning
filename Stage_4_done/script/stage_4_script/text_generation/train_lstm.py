...
from local_code.stage_4_code.text_generation.Method_LSTM import Method_LSTM
...
def main():
    ...
    result_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), "result/stage_4_result/text_generation/lstm")
    os.makedirs(result_dir, exist_ok=True)
    
    # Initialize data loader with 90/10 split
    data_loader = TextDataLoader(data_dir, seq_length=10, batch_size=64, train_ratio=0.9)
    ...
    # This part is trying to testing the biggest perplexity
    # Save metrics
    ...
    # Well, I;m trying to changed the different input words and check what's happend

    start_words = "what did the bartender say"
    temperatures = [0.5, 1.0, 1.5]  # Try different temperatures
